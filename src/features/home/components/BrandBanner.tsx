    ...
    >
      <div className="container-mb">
        <motion.p
          ...
          className="font-script text-center text-4xl text-cream drop-shadow-[0_4px_16px_rgba(0,0,0,0.4)] sm:text-5xl"
        >
          {HEADLINE}
        </motion.p>
        <p className="mt-4 font-display text-center uppercase tracking-[0.18em] text-amber sm:text-2xl">
          {SUBLINE}
        </p>
      </div>
    </section>
